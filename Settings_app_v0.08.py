VERSION = "0.08"
NAME = "Setting" # Имя программы, можно переименовать, поменяется имя окна и имя программы в о программе

# Если расскоментировать то имя будет GLUONiCA 
# и по умолчанию будет искать только часы GLUONiCA 
# плюс свое окно о программе
#NAME = "GLUONiCA" 
GLUON_only = True # Флаг для поиска только устройств с GLUON (если выбран #NAME = "GLUONiCA")
import sys,json, requests, ipaddress, os, socket
