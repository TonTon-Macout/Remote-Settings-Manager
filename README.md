...
+ поиск и отображение устройств в локальной сети с  установленной библиотекой  **Settings AlexGyver** <br>
  ...
  - Settings с адресом в сети интернет, добавляются вручную в окне "поиск и редактирование"
+ поиск и отображение устройств с **WLED**
  - WLED с адресом в сети интернет, добавляются вручную в окне "поиск и редактирование"
+ поиск и отображение **Home Assistant**
  - Home Assistant с адресом в сети интернет, добавляются вручную в окне "поиск и редактирование"
...
+ если скрыть приложение и развернуть, появляется строка с заголовком винды на фоне приложения
  ...
  + но исправления уже приняты и будут применены в будущих версиях, в какой точно хз, вероятно 6.10 (сейчас актуальная 6.9.1) https://codereview.qt-project.org/c/qt/qtbase/+/598187
    +  Qt 6.10 вышла, ждем теперь PyQt6.10...
